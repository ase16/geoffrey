 ...
 * @param callback
 */
Cloud.prototype.listWorkerInstances = function(zone, instanceGroup, callback) {
    var params = {
        zone: zone,
 ...
 * @param callback
 */
Cloud.prototype.resizeWorkerGroup = function(zone, instanceGroup, newSize, callback) {
    var params = {
        zone: zone,
        instanceGroupManager: instanceGroup,
        size: newSize
